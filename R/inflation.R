...
#'
#' @param initial_date Initial date in the 'DD/MM/YYYY' format (\code{character}).
#' @param end_date End date in the 'DD/MM/YYYY' format (\code{character}).
